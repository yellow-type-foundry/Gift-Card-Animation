 ...
 */
const Layout3Box = ({ boxColor = '#1987C7', logoPath = '/assets/GiftSent/SVG Logo/Apple.svg', progress = { current: 1, total: 25 }, className = '', style = {}, isHovered: externalIsHovered, hideProgressIndicator = false, enable3D = false, animationType = 'none', tiltX = 0, tiltY = 0, parallaxX = 0, parallaxY = 0 }) => {
